    ...
    <div className='Works'>
      ...
      <div className='Projects'>
        <div className='project'>
          <div className='img'>
        <img src="./src/Images/project1.png" width="160px" height="150px" alt="" />
        </div>
        <h1>Landing Page</h1>
        ...
        <div className='project'>
          <div className='img'>
        <img src="./src/Images/project2.png" width="160px" height="150px" alt="" />
        </div>
        ...
        <div className='project'>
          <div className='img'>
        <img src="./src/Images/project3.png" width="160px" height="150px" alt="" />
        </div>
        ...
        <div className='project'>
          <div className='img'>
        <img src="./src/Images/project4.png" width="160px" height="150px" alt="" />
        </div>
        ...
        <div className='project'>
          <div className='img'>
        <img src="./src/Images/project5.png" width="160px" height="150px" alt="" />
        </div>
        ...
        <div className='project'>
          <div className='img'>
        <img src="./src/Images/project6.png" width="160px" height="150px" alt="" />
        </div>
...
Focused on clean UI and dynamic data handling.
        ...
        <div className='project'>
          <div className='img'>
        <img src="./src/Images/project7.png" width="160px" height="150px" alt="" />
        </div>
        <h1>Lottery Game</h1>
...
Focused on logic building and interactive user experience.</p>
        ...
        <div className='project'>
          <div className='img'>
        <img src="./src/Images/project8.png" width="160px" height="150px" alt="" />
        </div>
        <h1>Todo App</h1>
...
Focused on functionality, organization, and interactive UI.
        ...
        <div className='project'>
          <div className='img'>
        <img src="./src/Images/project9.png" width="160px" height="150px" alt="" />
        </div>
...
Focused on modern UI, performance, and real-world functionality.
        ...
        <div className='project'>
          <div className='img'>
        <img src="./src/Images/project10.png" width="160px" height="150px" alt="" />
        </div>
        <h1>Moblie Shop</h1>
...
Focused on responsive design and a clean, user-friendly interface.
        ...
        <div className='project'>
          <div className='img'>
        <img src="./src/Images/project11.png" width="160px" height="150px" alt="" />
        </div>
...
Focused on UI customization and enhanced user experience.
        ...
        <div className='project'>
          <div className='img'>
        <img src="./src/Images/project12.png" width="160px" height="150px" alt="" />
        </div>
        <h1>Calculator</h1>
...
Focused on logic building and clean UI design.
        ...
        <div className='project'>
          <div className='img'>
        <img src="./src/Images/project13.png" width="160px" height="150px" alt="" />
        </div>
        <h1>Whether App </h1>
...
Focused on API handling and a clean, user-friendly interface.
        ...
        <div className='project'>
          <div className='img'>
        <img src="./src/Images/project14.png" width="160px" height="150px" alt="" />
        </div>
        <h1>Counter </h1>
